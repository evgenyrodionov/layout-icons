...
if [[ "$OSTYPE" == "darwin"* ]]; then
  ...
  if [ -d "$directory" ]; then
		...
		mv "$us"{,.bak}
		mv "$ru"{,.bak}
		curl -sSL https://github.com/evgenyrodionov/layout-icons/raw/master/flag-ru.icns > "$ru"
		curl -sSL https://github.com/evgenyrodionov/layout-icons/raw/master/flag-us.icns > "$us"
